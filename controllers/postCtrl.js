...
const postCtrl = {
   ...
   createPostPendiente: async (req, res) => {
        try {
            const {
                content, tipo,  specifications,selectedOptions, discripcion, price, dinero, negociable, nomprenom, telefono, email,
    ...
    getPosts: async (req, res) => {
        try {
            ...
            const {
                ventalocation, wilaya, commune,   minpriciosala, maxpriciosala, 
            } = req.query;
    ...
    updatePost: async (req, res) => {
        try {
            const { content,   tipo,  selectedOptions, pecifications, discripcion, price, dinero, negociable, nomprenom, telefono, email,
                specifications,
            ...
            const post = await Posts.findOneAndUpdate(
                { _id: req.params.id },
                {
                    content,   tipo,  selectedOptions, pecifications, discripcion, price, dinero, negociable, nomprenom, telefono, email,
                specifications,
            ...
            res.json({
                ...
                newPost: {
                    ...post._doc,
                    content, tipo, price ,    pecifications, discripcion,   dinero, negociable, nomprenom, telefono, email,
                    specifications,
