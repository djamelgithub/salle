...
const servicioCtrl = {
    ...
    createServicioPendiente: async (req, res) => {
        try {
            const {
                content, tipo, opcionesservicio, discripcion, precioservicio, dinero, negociable, nomprenom, telefono, email,
    ...
    getServicios: async (req, res) => {
        try {
            const {ventalocation, marca,modelo,  wilaya, commune, minprecioservicio, maxprecioservicio, selectedServices } = req.query;
            ...
            if (selectedServices && selectedServices.length > 0) {
                query.services = { $in: selectedServices };
            }
    ...
    updateServicio: async (req, res) => {
        try {
            const { content, tipo, opcionesservicio, discripcion, precioservicio, dinero, negociable, nomprenom, telefono, email,
            ...
            res.json({
                ...
                newServicio: {
                    ...servicio._doc,
                    content, tipo, precioservicio, opcionesservicio,   discripcion, dinero, negociable, nomprenom, telefono, email,
